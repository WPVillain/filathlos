    ...
    <!-- Carousel -->
      ...
      <ol class="carousel-indicators">
        <?php while ( $the_slides_query_ol->have_posts() ) : $the_slides_query_ol->the_post(); ?>
          <li data-target="#carousel" data-slide-to="<?php echo $the_slides_query_ol->current_post ?>" class="<?php if( $the_slides_query_ol->current_post == 0 ) echo 'active' ?>"></li>
        ...
        <?php while ( $the_slides_query->have_posts() ) : $the_slides_query->the_post(); ?>
          <div class="carousel-item <?php if( $the_slides_query->current_post == 0 ) echo 'active' ?>">
            <?php if (has_post_thumbnail()): ?>
                <?php the_post_thumbnail('b4-slider', ['class' => 'img-responsive responsive--full', 'title' => 'Feature image']);?>
                <?php endif; ?>
                  <!-- Static Header -->
